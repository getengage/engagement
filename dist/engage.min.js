...
var Scroll = function () {
  ...
  createClass(Scroll, [{
    ...
    value: function update() {
      var _Adapters$scrollCalc = Adapters.scrollCalc();

      var _Adapters$scrollCalc2 = slicedToArray(_Adapters$scrollCalc, 2);

      this.xPos = _Adapters$scrollCalc2[0];
      this.yPos = _Adapters$scrollCalc2[1];
...
var engage$2 = function () {
  ...
  createClass(engage, [{
    ...
    value: function toJSON() {
      var data = Object.assign({ api_key_id: this.options.api_key }, this.options.dimensions, this.manager.inspect());
